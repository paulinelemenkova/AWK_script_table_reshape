...
awk '{print $0}' < table_p07.csv | paste table_10pr.csv - > table_10h.csv
awk '{print $0}' < table_p14.csv | paste table_10h.csv - > table_10a.csv
awk '{print $0}' < table_p21.csv | paste table_10a.csv - > table_10b.csv
awk '{print $0}' < table_p28.csv | paste table_10b.csv - > table_10c.csv
awk '{print $0}' < table_p35.csv | paste table_10c.csv - > table_10d.csv
awk '{print $0}' < table_p42.csv | paste table_10d.csv - > table_10e.csv
awk '{print $0}' < table_p49.csv | paste table_10e.csv - > table_10f.csv
awk '{print $0}' < table_p56.csv | paste table_10f.csv - > table_10g.csv
awk '{print $0}' < table_p62.csv | paste table_10g.csv - > table_10h.csv
#
# awk: delete header and tail (print only lines which do NOT match regex)
awk '!/-L0-/' table_10h.csv > table_10KKT.csv
#
# remove auxiliary files
...
rm -f table_10pr.csv table_10h.csv table_10a.csv table_10b.csv table_10c.csv table_10d.csv table_10e.csv table_10f.csv table_10g.csv table_10h.csv
#
